...
flags.DEFINE_string("data_dir", "data/squad_out_span", "Data dir [data/squad_out_span]")
flags.DEFINE_string("data_scale", "0-400", "Dataset scale: 0-400 | 400-700 | 700- [0-400]")
flags.DEFINE_string("data_type", "span", "Dataset type: span | seq [span]")
...
flags.DEFINE_string("score_mode", "mul_score", "mul_score | avg_score [mul_score]")

# Training / test parameters
flags.DEFINE_integer("batch_size", 20, "Batch size [20]")
flags.DEFINE_integer("val_num_batches", 100, "validation num batches [100]")
flags.DEFINE_integer("test_num_batches", 0, "test num batches [0]")
flags.DEFINE_integer("num_epochs", 12, "Total number of epochs for training [12]")
flags.DEFINE_integer("num_steps", 100000, "Number of steps [10000]")
...
flags.DEFINE_bool("GRU", False, "Use GRUCell instead of LSTMCell in RNN? [False]")
flags.DEFINE_integer("highway_num_layers", 2, "highway num layers [2]")
flags.DEFINE_integer("num_modeling_layers", 1, "modeling layer num [1]")
...
flags.DEFINE_bool("use_exact_match", False, "use exact match feature? [False]")
flags.DEFINE_bool("use_self_match", True, "use self matching layer? [True]")
flags.DEFINE_bool("use_static_self_match", True, "use static self matching layer? [True]")
flags.DEFINE_bool("use_fused_lstm", True, "use block fused lstm? [True]")
