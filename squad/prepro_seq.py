...
def create_all(args):
    ...
    if os.path.exists(out_path):
        return
    train_path = os.path.join(args.source_dir, "train-v2.0.json")
    train_data = json.load(open(train_path, 'r'))
    dev_path = os.path.join(args.source_dir, "dev-v2.0.json")
            ...
            for qa in para['qas']:
                ...
                for answer in qa['answers']:
                    ...
                    for ans_idx, answer_start in enumerate(answer_location):
                        ...
                        yi0, _ = get_word_span(context, xi, answer_start, answer_stop)
